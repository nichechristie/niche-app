...
export function KingsChat() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "Welcome! I'm your biblical Kings history assistant. I can help you understand the reigns of Israel's and Judah's kings, their historical context, archaeological evidence, and the spiritual lessons from their stories. What would you like to learn about?"
    }
  ]);
  ...
  const sendMessage = async () => {
    ...
    try {
      const response = await fetch("/api/kings/chat", {
        method: "POST",
  ...
  const suggestedQuestions = [
    "Tell me about King David's reign",
    "Why did Solomon's kingdom divide?",
    "What were Hezekiah's reforms?",
    "How did archaeology confirm biblical kings?",
    ...
    <div className="glass rounded-xl flex flex-col h-[600px]">
      ...
      <div className="p-4 border-b border-slate-700">
        <h3 className="text-xl font-bold text-white flex items-center gap-2">
          ...
          Kings History Assistant
        </h3>
        <p className="text-sm text-gray-400 mt-1">
          Learn about the kings of Israel and Judah
        </p>
      </div>
      ...
      <div className="p-4 border-t border-slate-700">
        <div className="flex gap-2">
          <input
            ...
            placeholder="Ask about the kings of Israel and Judah..."
