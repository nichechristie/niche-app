    ...
    <div className="glass rounded-xl p-6 space-y-4">
      ...
      {!mediaPreview && !showCamera && (
        <>
          ...
          {/* AI Image Generation */}
          <div className="mt-3 p-4 bg-gradient-to-r from-purple-900/20 to-indigo-900/20 border border-purple-500/30 rounded-lg">
            ...
            <p className="text-xs text-gray-400 mt-2">
              Powered by DALL-E 3 - Generate unique images from text descriptions
            </p>
          </div>
        </>
      )}
