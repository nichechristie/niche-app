...
export function BibleChat() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "Hello! I'm your Bible study assistant. Ask me anything about the Bible, scripture interpretation, biblical history, theology, or spiritual guidance. How can I help you today?"
    }
  ]);
      ...
      <div className="p-4 border-t border-slate-700">
        <div className="flex gap-2">
          <textarea
            ...
            className="flex-1 bg-slate-700 text-white rounded-lg px-4 py-3 resize-none focus:outline-none focus:ring-2 focus:ring-indigo-500"
            rows={2}
            disabled={loading}
          />
          <button
            ...
            className="px-6 py-3 bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white rounded-lg font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Send
          </button>
        </div>
